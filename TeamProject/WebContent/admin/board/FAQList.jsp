	                  ...
	                  <c:when test="${listcount > 0}">
		                  <c:forEach var="articleList" items="${articleList }" varStatus="listStatus">
		                    ...
		                    <tr>
		                    	...
		                    	<a href='<c:url value="/admin/FAQModifyForm.adb?boardNum='${articleList.boardNum}'"/>'><input type="button" value="수정"></a>
		                    ...
		                    <script>
		                  		function checkOK() {
									...
									if(r){
										location.href="/admin/FAQDeletePro.adb?boardNum=" + ${articleList.boardNum};
									}
								}
		                  	</script>
		                  </c:forEach>
